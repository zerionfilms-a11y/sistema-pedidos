...
function buildMensagemPedido(p, etapa, rastreio=''){
  ...
  if(etapa === 'produzindo'){
    return `Oi, ${primeiroNome}! Seu pedido já foi produzido e está aguardando envio. Vou te manter por aqui com as atualizações.`
  }
  if(etapa === 'enviado'){
  ...
  if(etapa === 'finalizado'){
    return `Oi, ${primeiroNome}! Seu pedido foi finalizado. Obrigado pela confiança 🙌`
  }
